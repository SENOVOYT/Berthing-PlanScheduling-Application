...
class vessel{
   ...
   private $object;
    ...
    public function add_vessel($table_name,$clom,$vaules){
    ...
    public function Get_vessel($table_name,$array_colm_names,$condition){
    ...
    public function Update_vessel($table_name,$array_colm_names,$Array_value,$condition){
