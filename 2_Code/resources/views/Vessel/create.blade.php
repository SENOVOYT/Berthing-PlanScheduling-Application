        ...
        <div id="content">
            ...
            <form action="/vessels" method="POST" style="margin: 49px;padding-left: 1px;">
                ...
                <div class="container" style="padding-left: 0px;">
                    ...
                    <div class="row" style="padding-bottom: 20px;width: 599px;">
                        <div class="col-md-6"><label class="form-label" for="histacker-operator"><strong>HiStacker Operator</strong></label><select class="form-select" id="histacker-operator" name="histackeroperator" required="">
