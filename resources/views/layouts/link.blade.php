...
<nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="color: var(--bs-blue);--bs-primary: #401f88;--bs-primary-rgb: 64,31,136;">
    <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
        ...
        <ul class="navbar-nav text-light" id="accordionSidebar">
            ...
            <li class="nav-item"><a class="nav-link" href="shipschedule.html"><i class="fas fa-table"></i><span>Ship Schedule</span></a></li>
            <li class="nav-item"></li>
            <li class="nav-item"><a class="nav-link" href="delays.html"> <i class="fas fa-exclamation-circle"></i><span> Delays </span></a></li>
            <li class="nav-item"></li>
            <li class="nav-item"><a class="nav-link" href="reports.html"><span><i class="fas fa-file-excel"></i><span>Reports</span></a></li>
            <li class="nav-item"></li>
            <li class="nav-item"></li>
        </ul>
